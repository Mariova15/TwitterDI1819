 ...
 * @author mouse
 */
public class Jswitch extends JComponent implements MouseListener {
    ...
    public Jswitch(){
        super();
        Jswitch.this.setSize(new Dimension(60, 40));
        Jswitch.this.setPreferredSize(new Dimension(60, 40));
        Jswitch.this.setMinimumSize(new Dimension(60, 40));
        Jswitch.this.setVisible(true);
        Jswitch.this.setCursor(new Cursor(Cursor.HAND_CURSOR));
        Jswitch.this.addMouseListener(Jswitch.this);  
        //colores iniciales
        Jswitch.this.setBackgroundColor(new Color(56,161,243));
        Jswitch.this.setButtonColor(new Color(255,255,255));
    }
