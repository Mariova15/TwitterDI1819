...
public class CifradoRsa {
     ...
     public byte[] encriptar(String msng) throws NoSuchAlgorithmException, 
     ...
     public String desencriptar(byte[] data) throws NoSuchAlgorithmException, 
     ...
     public String sha256(String msng) throws NoSuchAlgorithmException{
